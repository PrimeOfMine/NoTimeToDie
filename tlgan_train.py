...
class tlgan:
    def __init__(self, batch_size, save_dir, target_img=(3, 256, 256), save_path="./weights"):
    ...
    def train(self, data, epochs, show_at_100_epochs=False):
        ...
        for epoch in range(epochs):
            ...
            for img, real in tqdm(data_iter):
...
if __name__ == '__main__':
    ...
    data = DataLoader(datasets.TLGAN_Dataset(path_to_csv="./data/TLGAN.csv", path_to_img="./data/images/TLGAN",
                                             path_to_GT="./data/images/gaussian_map"), batch_size=args.batch_size)
    tl_handler = tlgan(batch_size=args.batch_size, save_dir="./data/", target_img=(3, 256, 256), save_path=args.model_path)
